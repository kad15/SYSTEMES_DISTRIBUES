...
/**
 * Marking interface for messages (empty). 
 * Implemented by (automatically generated) users' message classes.
 *
 * @version 0.4.0 Delta
 */
public interface Message extends Serializable {
    /**
     * The method allowing a behavior to process a message. The code is
     * automatically generated.
     *
     * @param b the behavior
     * @throws an exception when b has no method for the message.
     */
