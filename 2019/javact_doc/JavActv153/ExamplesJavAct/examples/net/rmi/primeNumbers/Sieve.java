...
package examples.net.rmi.primeNumbers;

import org.javact.util.ActorProfile;

/**
 * Specifies a behavior which sifts an int or suicides. It's also a ActorProfile,
 * because it's the unique interface of all the behaviors  of the actor.
 */
