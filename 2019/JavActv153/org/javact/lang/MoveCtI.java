...
/**
 * *META-COMPONENT-LEVEL* Specification of a Move component. Implemented by 
 * MoveCt (in a package used for distribution). Implementable by a user 
 * meta-component-level class.
 *
 * @version 0.5.0
 */
public interface MoveCtI extends JavActComponentInt {
    /**
     * Ability of changing the hosting place
     *
