...
* Modified by : Sébastien LERICHE (version delta)
...
/**
 * The receive component of an actor. Implements NetActor (consequently, Actor).
 * This component can't be adapted. Middleware-level only.
 *
 * @version 0.5.0
 */
public class ReceiveCt  extends JavActComponent implements NetActor {

    /**
     * Reception of standard messages, transmited to the Controler
     *
     * @param m the message
     *
     * @throws RemoteException (RMI)
     */
    public final void receive(Message m) throws RemoteException {
