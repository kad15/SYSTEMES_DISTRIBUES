...
/**
 * Specifies the interface of a client-side object, which is in charge of
 * recovering the answer for a client and updating the Future delegate of the
 * MessageWithReply.  Middleware-level only.
 *
 * @version 0.5.0
 */
public interface ClientSideAnswerBackLocal {
