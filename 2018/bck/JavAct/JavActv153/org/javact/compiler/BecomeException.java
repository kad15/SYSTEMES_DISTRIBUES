...
/** This exception occurs when a BehaviorProfile interface declares malformed
 * <code>become</code> methods (bad return type, bad number &amp; type of
 * parameters.
 *
 * @author Vincent Hennebert
 * @version 0.5.0
 */
class BecomeException extends java.lang.Exception
{
    BecomeException(String message)
    {
	super(message);
    }
}
